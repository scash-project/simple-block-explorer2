...
$time_start = microtime(true); 
  ...
  $MAIN_ENDPOINT = "http://127.0.0.1:8342/"; // SCASH PORT
  $TEST_ENDPOINT = "http://127.0.0.1:18342/"; // SCASH PORT
  define("BASE_URL", "/"); #set to absolute URL, use "/" if in root directory
  define("USE_MOD_REWRITE", true);
	define("RPC_USER", "user"); // CHANGE THIS
	define("RPC_PASS", "password"); // CHANGE THIS
  ...
  $FOOTER = '<a href="https://github.com/scash-project/simple-block-explorer">Simple Block Explorer</a> for Scash';
...
###### END CONFIG SECTION
			...
			if (isset($_REQUEST['utxolookupstatus'])) {
				...
				if(is_null($data->result)) {
					...
					if(!is_null($data->result)) {
						...
						echo "<hr /><div class=\"totalamount\"><b>Total unspent SCASH:</b> ".$data->result->total_amount."</div><br>\n";
  ...
  function getLastBlocks($tophash, $blk_count = 12) {
    ...
    for ($i=0;$i<$blk_count;$i++) {
      ...
      if (empty($lastblocks[count($lastblocks)-1])) { continue; } // Fix null bug when chain only has genesis block
  ...
  function btcamount($amount) {
    return number_format($amount, 8, ".", "'")." SCASH";
  }
	  ...
	  <div class="container-fluid">
	    ...
	    <div class="collapse navbar-collapse" id="navbarSupportedContent">
	      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
	        <li class="nav-item">
						<a class="nav-link <?php if($ENDPOINT == $MAIN_ENDPOINT) echo "active"; ?>" href="<?php echo overviewlink(); ?>" aria-current="page" >Scash</a>
	        </li>
	        <li class="nav-item">
	      ...
	      <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
	        ...
	        <li class="nav-item py-1 px-0 px-lg-2">
						<a href="https://github.com/scash-project/simple-block-explorer" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#fff" class="bi bi-github" viewBox="0 0 16 16">
  ...
  <div class="row mb-4">
    <div class="col">
			<ol class="list-group mb-2">
			  ...
			  <li class="list-group-item d-flex justify-content-between align-items-start">
			    <div class="ms-2 me-auto">
			      <div class="fw-bold">Bits</div>
						0x<?php echo $block->bits; ?>
			    </div>
			  </li>
			  <li class="list-group-item d-flex justify-content-between align-items-start">
			    <div class="ms-2 me-auto">
			      <div class="fw-bold">Difficulty</div>
						<?php echo $block->difficulty; ?>
			    </div>
			  </li>
    ...
    <div class="col">
			<ol class="list-group">
			  ...
			  <li class="list-group-item d-flex justify-content-between align-items-start">
			    <div class="ms-2 me-auto">
			      <div class="fw-bold">RandomX Epoch</div>
						<?php echo $block->rx_epoch; ?>
			    </div>
			  </li>
			  <li class="list-group-item d-flex justify-content-between align-items-start">
			    <div class="ms-2 me-auto">
			      <div class="fw-bold">RandomX Hash</div>
			      <span><?php echo shortHash($block->rx_hash); ?></span>
						<a href="#" data-bs-toggle="collapse" data-bs-target="#collapseRxHash" aria-expanded="false" aria-controls="collapseRxHash">(Show full hash)</a>
						<div class="collapse" id="collapseRxHash">
						  <div class="" style="font-size:.7em">
						    <?php echo $block->rx_hash; ?>
						  </div>
						</div>
			    </div>
			  </li>
			  <li class="list-group-item d-flex justify-content-between align-items-start">
			    <div class="ms-2 me-auto">
			      <div class="fw-bold">RandomX Commitment</div>
			      <span><?php echo shortHash($block->rx_cm); ?></span>
						<a href="#" data-bs-toggle="collapse" data-bs-target="#collapseRxCm" aria-expanded="false" aria-controls="collapseRxCm">(Show full commitment)</a>
						<div class="collapse" id="collapseRxCm">
						  <div class="" style="font-size:.7em">
						    <?php echo $block->rx_cm; ?>
						  </div>
						</div>
			    </div>
			  </li>
